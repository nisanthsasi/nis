...
*Status: CORE_LOCK ✅ · WORLD_CHAR ✅ · STRUCTURE ✅ · (next: VISUAL_HANDOFF → DRAFT)*
...
## 1. Logline
On a remote southern-Kerala shore, a kept woman who has been quietly saving for her escape kills her abusive husband in a single violent night — and uses the lover who adores her to erase the body, only to erase him too: she burns the hut and vanishes with the money, leaving him a voice note. Told in **one continuous 90-minute take.**

## 2. Spine (locked)
**"The savings were always the exit; the love was the accident."**
She wasn't saving for *them* — the rice-pot hoard was her exit fund all along; the lover was the *means* (money + a man with a boat). Then she fell in love — the one thing the plan didn't allow. The killing is not the plan; it is the **detonator** that forces the timeline. When the moment comes, **freedom wins, and he is the price.** Love real, betrayal real, **fused.**

- Escape = **premeditated**. Murder = **self-defense escalation** she then exploits with terrifying readiness.

## 3. Format & Camera Grammar (locked)
- **90-minute single continuous take** (real time = screen time = shoot time). Method: *Victoria* (true oner, not VFX-stitched).
- **Camera locked to HER** after an opening hand-off; **never boards the boat** — the sea-disposal happens at the edge of frame as a distant light while we stay with her (this is what makes a oner of this story possible).
- **The unbroken shot IS the indicted gaze** — surveillance/ownership (lover's eye, husband's eye, ours). The climax is **she walks out of frame**, escaping the gaze itself. Form = meaning.
- **Ending (B):** she exits frame; we hold on the burning hut and the distant, abandoned man; we never cut to him.

## 4. Scores (AUTEUR engines)
| Engine | Score | Verdict |
|---|---|---|
| PSS (Premise Strength, §7) | **90** | Priority greenlight |
| CAS (Cult-Appeal, §3) | **88** | Priority greenlight |
| DHS / CPI | pending first draft | — |

Single-take format lifted PSS 77→90 and CAS 74→88 (Hook/Originality/Marketability + Aesthetic Signature, Rewatchability, "how'd they do it?" fandom).

## 5. The Cage
Why she can't just leave: economic dependence (owns nothing but the hidden hoard), the husband's claim on body + land, the remoteness of the shore. The savings are her slow tunnel out. The murder forces the escape before she is ready — the engine.
...
- **Contradiction:** provides nothing, claims everything; a flicker of ruined tenderness so he isn't cardboard (§16/F6).
- **Arc Delta:** predator → corpse (power inversion at midpoint).
- **Function:** the detonator.

## 7. Structure — Real-Time Beat Map (90 min) + Camera Path
Time = screen time = shoot time. Camera locked to her after the opening hand-off.

| Clock | Beat (Story Circle) | Camera path / geography |
|---|---|---|
...
**Three ticking clocks** sustaining the unbroken 90: **tide/dawn** (dump before light), **the curry** (domestic timer turned grim), **the money** (rice-pot object: planted → spills at midpoint → walks out the door).

**§9 failure check:** soft midpoint ✗ · saggy Act 2 ✗ · cage leak ✗ · deus ex machina ✗ · concept stagnation ✗ — all clear.
